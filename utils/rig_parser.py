#-------------------------------------------------------------------------------
# hard-coded skeletal tree
def get_joint_names():
    return ['Hips', 'Spine', 'Spine1', 'Spine2', 'Neck', 'Head', 'LeftShoulder', 'LeftArm', 'LeftForeArm',
               'RightShoulder', 'RightArm', 'RightForeArm', 'LeftUpLeg', 'LeftLeg', 'LeftFoot', 'LeftToeBase',
               'RightUpLeg', 'RightLeg', 'RightFoot', 'RightToeBase', 'LeftHand', 'RightHand']
...
# This file is from RigNet(https://github.com/zhan-xu/RigNet), and revised.
